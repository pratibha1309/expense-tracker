...
// const mongodbURI = 'mongodb+srv://sharmapratibha130904:DDHccYPfo5CrTqqj@personalexpensetracker.qlcdk.mongodb.net/?retryWrites=true&w=majority&appName=PersonalExpenseTracker';
const mongodbURI = 'mongodb+srv://sharmapratibha130904:TpL8vHT9APmSZTxH@cluster0.mjmyw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
const databaseName = 'Cluster0';

const JWT_SECRET = '123code'; 
  ...
  .then(() => {
    ...
    app.post('/signup', async (req, res) => {
      ...
      try {
        ...
        const newUser = { name, email, phone, password: hashedPassword, salary: 0, expenses: [] };//bycrpyt
